  ...
  return (
    <div className='flex flex-col items-center mt-6 lg:mt-20'>
      <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
        VirtuaIr Build Tools <span className='text-orange-500'>For Developers</span>
      </h1>
      ...
      <div className="flex justify-center py-10">
        ...
        <a href="#" className='py-3 px-4 mx-3 rounded-md border border-neutral-400'>
          Documentation
        </a>
      </div>

      <div className="flex justify-center my-10 gap-6">
        <video autoPlay loop muted className='rounded-lg w-1/2 border-2 border-orange-700 shadow-lg'>
